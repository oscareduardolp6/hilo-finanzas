...
> **Implementada.** Los doce pasos están hechos y `src/legacy/` ya no existe; el
> plan, con el detalle de cada paso y el porqué de cada decisión, está en
> [agents/plans/layered-architecture.md](../agents/plans/layered-architecture.md).
> Las dudas abiertas de abajo quedaron resueltas así: arquitectura feature-first
...
> `hilo-finanzas.jsx` convertido en barrel — los 190 tests de regresión no
